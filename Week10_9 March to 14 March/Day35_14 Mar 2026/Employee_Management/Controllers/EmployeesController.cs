...
namespace Employee_Management.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var companyContext = _context.Employees.Include(e => e.Department);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,Name,DepartmentId")] Employee employee)
        {
