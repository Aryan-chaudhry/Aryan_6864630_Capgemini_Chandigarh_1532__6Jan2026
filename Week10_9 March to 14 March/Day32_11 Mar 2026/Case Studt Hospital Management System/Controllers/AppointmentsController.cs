...
namespace Case_Studt_Hospital_Management_System.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        {
            var hospitalDbContext = _context.Appointments.Include(a => a.Doctor).Include(a => a.Patient);
        ...
        public async Task<IActionResult> Create([Bind("AppointmentId,PatientId,DoctorId,AppointmentDate,Remarks")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AppointmentId,PatientId,DoctorId,AppointmentDate,Remarks")] Appointment appointment)
        {
