...
namespace University_Management_System.Controllers
{
    public class StudentController : Controller
    {
        ...
        public StudentController(UniversityManagementDBcontext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StudentId,FullName,Email,EnrollmentDate")] StudentModel studentModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,FullName,Email,EnrollmentDate")] StudentModel studentModel)
        {
